...
double Angle::angleDiff(double scalar) const { return (*this - scalar).angle; }
...
bool Angle::operator==(const Angle &other) const { return fabs(Angle(this->angle - other.angle).angle) < VECTOR_PRECISION; }
