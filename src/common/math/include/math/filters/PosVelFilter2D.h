...
#ifndef SOCCER_SRC_COMMON_MATH_FILTERS_POSVELFILTER2D_H_
#define SOCCER_SRC_COMMON_MATH_FILTERS_POSVELFILTER2D_H_
...
#endif //SOCCER_SRC_COMMON_MATH_FILTERS_POSVELFILTER2D_H_
