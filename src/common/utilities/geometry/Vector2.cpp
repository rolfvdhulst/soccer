...
Angle Vector2::toAngle() const { return Angle(atan2(y, x)); }
...
bool Vector2::operator==(const Vector2 &other) const { return fabs(this->x - other.x) < VECTOR_PRECISION && fabs(this->y - other.y) < VECTOR_PRECISION; }
