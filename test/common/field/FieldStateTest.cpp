...
bool lineHorizontal(const LineSegment &line) {
    return line.start.y == line.end.y;
}
bool lineVertical(const LineSegment &line) {
    return line.isVertical();
}
bool leftToRight(const LineSegment &line) {
    return line.start.x < line.end.x;
}
bool rightToLeft(const LineSegment &line) {
    return ! leftToRight(line);
}
bool bottomToTop(const LineSegment &line) {
    return line.start.y < line.end.y;
}
bool topToBottom(const LineSegment &line) {
    return ! bottomToTop(line);
}
